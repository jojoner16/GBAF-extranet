<?php
    ...
    if (isset($_SESSION['nom']) && isset($_SESSION['prenom']) && isset($_SESSION['id_user']) && isset($_GET['vote']) && isset($_GET['id_acteur'])) 
    {
        ...
        $req_vote_user = $pdo->prepare('SELECT vote FROM vote WHERE id_acteur = ? AND id_user = ?');
        ...
        {
            // on Ajoute son vote
            $req_insert_vote = $pdo->prepare('INSERT INTO vote (id_user, id_acteur, vote) VALUES (:id_user, :id_acteur, :vote)');
        ...
        {
            // on change son vote
            $req_update_vote = $pdo->prepare('UPDATE vote SET vote = :vote WHERE id_user = :id_user AND id_acteur = :id_acteur');
