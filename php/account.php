...
function searchUser($bdd, $userName)
{
    ...
    $req_select_info_user = $bdd->prepare('SELECT * FROM user WHERE username = ?');
...
define("PASSWORD_WRONG",        "Ce n'est pas le bon mot de passe minimum 1 lettre 1 maj et 1 chiffre");
